...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">SMW1368</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
<section class="section dashboard">
    <div class="row col-lg-11 m-auto">
                ...
                <div class="card info-card sales-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=tripleGetter("https://service.tib.eu/lablsk-sparql/fuseki/smw1368/query")?></h6>
                ...
                <div class="card info-card revenue-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=subjecteGetter("https://service.tib.eu/lablsk-sparql/fuseki/smw1368/query")?></h6>
                ...
                <div class="card info-card customers-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=predicateGetter("https://service.tib.eu/lablsk-sparql/fuseki/smw1368/query")?></h6>
                ...
                <div class="card info-card revenue-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=objecteGetter("https://service.tib.eu/lablsk-sparql/fuseki/smw1368/query")?></h6>
        ...
        <script>
            ...
            var query_1 = prefix + "SELECT ?Distribution ?Description ?Title ?Format ?Media_Type ?Acssess_URL WHERE { \n" + "?Dataset a dcat:Dataset .\n" + "?Dataset dct:description ?Description ;\n" + "dct:title ?Title ;\n" + "dct:issued ?Issued ;\n" + "dct:publisher ?Publisher ;\n" + "dcat:distribution ?Distribution ;\n" + "} LIMIT 100";
            ...
            function submitQuery() {
                ...
                var url = "https://service.tib.eu/lablsk-sparql/fuseki/smw1368/query";
                // Create cURL request
