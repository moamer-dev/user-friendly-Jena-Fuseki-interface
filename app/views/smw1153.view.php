...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">SMW1153</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
    ...
    <div class="row col-lg-11 m-auto">
                ...
                <div class="card info-card sales-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=tripleGetter("https://service.tib.eu/lablsk-sparql/fuseki/smw1153/query")?></h6>
                ...
                <div class="card info-card revenue-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=subjecteGetter("https://service.tib.eu/lablsk-sparql/fuseki/smw1153/query")?></h6>
                ...
                <div class="card info-card customers-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=predicateGetter("https://service.tib.eu/lablsk-sparql/fuseki/smw1153/query")?></h6>
                ...
                <div class="card info-card revenue-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=objecteGetter("https://service.tib.eu/lablsk-sparql/fuseki/smw1153/query")?></h6>
        ...
        <script>
            ...
            function submitQuery() {
                ...
                var url = "https://service.tib.eu/lablsk-sparql/fuseki/smw1153/query";
                // Create cURL request
