    ...
    <div class="row col-lg-11 m-auto">
                ...
                <div class="card info-card sales-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=tripleGetter("https://service.tib.eu/lablsk-sparql/fuseki/ckan1153/query")?></h6>
                ...
                <div class="card info-card revenue-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=subjecteGetter("https://service.tib.eu/lablsk-sparql/fuseki/ckan1153/query")?></h6>
                ...
                <div class="card info-card customers-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=predicateGetter("https://service.tib.eu/lablsk-sparql/fuseki/ckan1153/query")?></h6>
                ...
                <div class="card info-card revenue-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6><?=objecteGetter("https://service.tib.eu/lablsk-sparql/fuseki/ckan1153/query")?></h6>
        ...
        <!-- Query Editor columns -->
            <div class="col-xxl-8 col-sm-6">
                <button type="button" class="btn btn-nfdi" data-bs-toggle="modal" data-bs-target="#modalDialogScrollable"><i class="bi bi-folder2-open mx-1"></i> Ready to use Queries </button>
